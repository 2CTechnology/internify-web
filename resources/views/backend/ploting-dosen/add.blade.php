...
@section('content')
    <form action="{{ route('ploting-dosen.ploting-dosen.store') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6 mt-2">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control @error('jumlah_kelompok') is-invalid @enderror" name="jumlah_kelompok" value="{{ old('jumlah_kelompok') }}">
