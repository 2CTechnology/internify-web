            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" class="form-control"
                        value="{{ $item->kelompok->dospem ? $item->kelompok->dospem->no_identitas : '-' }}" readonly>

                    <label for="nama" class="label-form-control mt-2">Nama Dosen</label>
                    <input type="text" class="form-control" value="{{ optional($item->kelompok->dospem)->name }}"
                        readonly>
                    <hr>
                    ...
                    @if ($item->proposal)
                        <label for="proposal" class="label-form-control mt-2">File Proposal</label>
                        <div>
                            <a href="{{ asset($item->proposal) }}" target="_blank" class="btn btn-success">
