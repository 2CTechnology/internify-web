        ...
        <div class="row">
            ...
            <div class="col-md-6 mt-2">
                <div class="form-group">
                    ...
                    <textarea name="deskripsi_pekerjaan" id="" cols="" rows="" class="form-control">{{ old('deskripsi_pekerjaan') }}</textarea>
            ...
            <div class="col-md-6 mt-2">
                <div class="form-group">
                    ...
                    <textarea name="deskripsi_perusahaan" id="" cols="" rows="" class="form-control">{{ old('deskripsi_perusahaan') }}</textarea>
            ...
            <div class="col-md-6 mt-2">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('employee_size') is-invalid @enderror" name="employee_size" value="{{ old('employee_size') }}">
                    @error('employee_size')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="col-md-6 mt-2">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('head_office') is-invalid @enderror" name="head_office" value="{{ old('head_office') }}">
                    @error('head_office')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="col-md-6 mt-2">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('since') is-invalid @enderror" name="since" value="{{ old('since') }}">
                    @error('since')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="col-md-6 mt-2">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('specialization') is-invalid @enderror" name="specialization" value="{{ old('specialization') }}">
            ...
            <div class="col-md-6 mt-2">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('kriteria') is-invalid @enderror" name="kriteria" value="{{ old('kriteria') }}">
                    @error('kriteria')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
